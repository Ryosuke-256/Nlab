...
//box1
const box1_geometry=new THREE.BoxGeometry(10,10,10)
...
box1_mesh.position.set(0,-100,0)
scene.add(box1_mesh)

//BufferGeometry
const buffer1_geometry = new THREE.BufferGeometry()
const count = 50
...
buffer1_geometry.setAttribute('position',positionsAttribute)
const buffer1_material = new THREE.MeshBasicMaterial({color:0xff0000,wireframe:true})
const buffer1_mesh = new THREE.Mesh(buffer1_geometry,buffer1_material)
scene.add(buffer1_mesh)
